### Howdy there 👋, this is Karthik here!
...
[![StackOverflow](https://stackoverflow-badge.onrender.com/api/StackOverflowBadge/498604)](https://stackoverflow.com/users/498604/karthiks)
...
- [Github Gist referenced from my blog on WSL2 Cheatsheet](https://gist.github.com/karthiks/1700a56b7bfb79e6e1c345230c2e26b6)
- [Twilio Ruby](https://github.com/karthiks/twilio-ruby) is Ruby port of Twilio ADK to access its Telephony APIs. Added a small feature to make it SaaS ready for B2B customers. 
- [DhanHQ-py](https://github.com/karthiks/DhanHQ-py) is Python SDK to Dhan Broking platform
- [DhanHQ-java](https://github.com/karthiks/DhanHQ-java) is Java SDK to Dhan Broking platform
- [Query Blogger MCP Server](https://github.com/karthiks/query_blogger_mcp_server) is MCP server to Blogger platform
- [agnoagi/Agno](https://github.com/agno-agi/agno/issues/6862) is the fastest AI Agentic Framework that is production ready
- [Memsearch](https://github.com/zilliztech/memsearch/issues/252) is persistent memory layer for AI Agents
- [louis49/melchizedek](https://github.com/louis49/melchizedek/issues/18) is persistent memory for Claude Code
- [CCR](https://github.com/musistudio/claude-code-router/issues/1309) is an AI Gateway to bridge Claude Code with LLM from other platforms.
